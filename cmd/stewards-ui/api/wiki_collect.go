...
type wikiListResp struct {
	Items []wikiCollectBrief `json:"items"`
...
func (d *Deps) wikiListHandler(w http.ResponseWriter, r *http.Request) {
	...
	defer cancel()
	resp := wikiListResp{Items: []wikiCollectBrief{}}
