...
DECLARE
    v_write_names text[] := ARRAY['reminder_set','reminder_cancel','companion_approve'];
    v_tool_names  text[] := ARRAY['forge_register','reminder_set','reminder_list','reminder_cancel','companion_bell','companion_approve'];
    v_allow jsonb;
    v_kept  jsonb;
    v_deact int := 0;
BEGIN
