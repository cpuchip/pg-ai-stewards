...
SELECT count(*) AS studies FROM stewards.docs;
...
SELECT * FROM stewards.doc_citations('verify-quote-test');
...
DELETE FROM stewards.docs WHERE slug = 'verify-quote-test';
SELECT * FROM cypher('stewards_graph', $$
